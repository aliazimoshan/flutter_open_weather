...
class HttpWeatherRepository {
  ...
  Future<Forecast> getForecast({required GeoPoint geoPoint}) => _getData(
        uri: api.forecast(geoPoint),
        builder: (data) => Forecast.fromJson(data),
      );

  Future<Weather> getWeather({required GeoPoint geoPoint}) => _getData(
        uri: api.weather(geoPoint),
